    ...
    public class StoreContext
    {
        public StoreContext()
        {
            Tasks = new Collection<ITask>
            {
                ...
                Task.Load(new Guid("4b2f8170-c618-4cd6-91b9-25e3b2bfa53e"), "Clone the repository", false),
                Task.Load(new Guid("360644f3-abb5-410b-939d-78a6d07bd075"), "Create a branch", false),
